...
public class TagFabLayout extends ViewGroup {
    ...
    private void getAttributes(Context context, AttributeSet attributeSet) {
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.TagFabLayout);
        mTagText = typedArray.getString(R.styleable.TagFabLayout_tagText);
        typedArray.recycle();
    }
